...
def mostra_immagine_pokemon_ui(id_pokemon):
    try:
        ...
        path_to_image_pkmnimg= os.path.join(os.path.dirname(__file__), 'Assets', 'PokemonGen', 'Gen'+gen_selection+'.png')
        ...
        spritesheet = Image.open(path_to_image_pkmnimg)
...
def mostra_immagine_tipo_ui(id_type):
    try:
        path_to_image_pkmntypeimg= os.path.join(os.path.dirname(__file__), 'Assets', 'PokemonType', 'types_label.png')
        spritesheet = Image.open(path_to_image_pkmntypeimg)
